...
| 13 | 048b | Host smoke test matrix (host-matrix.md + macOS host runs) | qa | M | 046, 048 | done |
...
| 16 | 059 | Fix AU crash — FxEngine::prepare() races processBlock (prepareToPlay not audio-thread-safe) | plugin | M | — | done |
